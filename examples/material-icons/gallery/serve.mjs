...
const SECTIONS = [
  {
    ...
    icons: [
      ...
      "account-circle", "done", "info", "check-circle",
      "expand-more", "visibility", "edit", "email",
      "description", "logout", "arrow-back", "favorite-border",
      "chevron-right", "lock", "local-shipping", "location-on",
      "schedule", "call", "language", "file-download",
      "cancel", "arrow-forward-ios", "groups", "arrow-back-ios",
      "help-outline", "arrow-drop-down", "verified", "face",
      "manage-accounts", "play-arrow", "place", "more-vert",
      "thumb-up", "add-circle-outline", "filter-alt", "dashboard",
      "event", "fingerprint", "list", "content-copy",
      "people", "check-circle-outline", "visibility-off", "add-circle",
      "login", "arrow-forward", "send", "warning",
    ],
  },
  {
    title: "Social",
