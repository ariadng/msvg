/**
 * A minimal, self-contained Web Animations API mock for this example's
 * integration test. happy-dom implements neither `Element.prototype.animate`
 * nor a controllable `matchMedia`. Owned by this package; imports no other
 * package's test helpers. Not a `*.test.ts` file.
 */
